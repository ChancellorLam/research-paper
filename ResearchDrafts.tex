...
\begin{document}
	...
	\begin{proof}
		...
		\begin{center}
			...
			\end{tikzpicture}
		\end{center}
		This provides us with 7 different distances, $(3,3),(1,3),(2,2),(1,1),(0,2),(3,1),$ and $(2,0)$. Consider the fact that these are all unique distances. It follows then that the runner must be caught.
		...
		\begin{center}
			...
			\end{tikzpicture}
		\end{center}
		This provides us with 5 different distances, $(0,2),(2,2),(2,0),(1,1)$ and $(3,1)$. Consider the fact that these are all unique distances. It follows then that the runner must be caught.
