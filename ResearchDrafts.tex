...
\begin{document}
	...
	\begin{proof}
		...
		\textbf{Case 1:} Consider the case where the chaser has been returned a distance of $(1,2)$ from the first probes on vertices $E$ and $H$. Then the runner must be at one of the vertices $A,F$, or $K$. Recall that runner cannot move on to $E$ or $H$ because of the no backtracking condition. It follows then that the runner has the ability to move to any of the neighboring vertices $B,C,G,I,L$. Thus, the runner could potentially be located at any of the vertices $A,B,C,F,G,I,K,L$.
		...
		\textbf{Case 2:} Consider the case where the chaser has been returned a distance of $(2,1)$ from the first probes on vertices $E$ and $H$. Then the runner must be at one of the vertices $B,G$, or $L$. Recall that runner cannot move on to $E$ or $H$ because of the no backtracking condition. It follows then that the runner then has the ability to move to any of the neighboring vertices $A,D,F,J,K$. Thus, the runner could potentially be located at any of the vertices $A,B,D,F,G,J,K,L$.
